...
<body  class="white-bg">
	<!-- 普通用户查重界面代码 -->
               		<div id="article_page" class="col-lg-push-3 col-lg-pull-3 col-lg-12">
               			...
               			<form id="upArticleForm" class="form-horizontal" role="form" method="post" action="resource/history/bashaddhistory">
                            ...
                            <div class="form-group">
								<div class="col-lg-offset-6 col-lg-6">
									<button id="submitUpArticleForm" type="submit" class="btn btn-info">更新</button>
								</div>
							</div>
                           </form>
               		</div>
	...
	<script type="text/javascript" src="static/js/mydataTable.js"></script>
  	...
  	<script type="text/javascript" src="static/js/historyjs/history.js"></script>
</body>
</html>